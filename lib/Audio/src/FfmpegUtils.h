...
namespace srt::audio::internal {
    ...
    /// @brief Convert srt::audio SampleFormat to FFmpeg AVSampleFormat.
    ...
    /// @brief Convert FFmpeg AVSampleFormat to srt::audio SampleFormat.
