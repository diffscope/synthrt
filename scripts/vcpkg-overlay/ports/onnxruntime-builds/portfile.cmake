...
# Import libraries live under runtime/<flavor>/import/ (whitelisted, per-flavor
...
#   <share>/runtime/default/  default payload (DirectML on Windows), incl.
#                             pdb/dSYM debug symbols sitting next to the DLLs
#   <share>/runtime/cuda/     CUDA 12 payload (cuda12 feature only), same rule
#   <flavor>/import/          import libraries, per-flavor private
...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    # port-private runtime directory instead. (*.dll only — pdb/next to the
    # DLLs in the runtime dir are never mirrored.)
