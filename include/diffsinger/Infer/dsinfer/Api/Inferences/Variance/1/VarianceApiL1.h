...
namespace srt::svs::Api::Variance::L1 {
    ...
    class VarianceSchema : public srt::svs::InferenceSchema {
    public:
        inline VarianceSchema() : srt::svs::InferenceSchema(API_NAME, API_CLASS, API_LEVEL) {
        }
    ...
    class VarianceConfiguration : public srt::svs::InferenceConfiguration {
    public:
    ...
    class VarianceImportOptions : public srt::svs::InferenceImportOptions {
    public:
    ...
    class VarianceRuntimeOptions : public srt::svs::InferenceRuntimeOptions {
    public:
    ...
    class VarianceInitArgs : public srt::svs::InferenceInitArgs {
    public:
    ...
    class VarianceStartInput : public srt::core::TaskStartInput {
    public:
        inline VarianceStartInput() : srt::core::TaskStartInput(API_NAME) {
        }
    ...
    class VarianceResult : public srt::core::TaskResult {
    public:
        using InputParameterInfo = Common::L1::InputParameterInfo;

        inline VarianceResult() : srt::core::TaskResult(API_NAME) {
        }
