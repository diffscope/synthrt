...
namespace ds::infer::inferutil {
    ...
    private:
        ...
        const srt::svs::InferenceSpec *spec;
        ErrorCollector *ec;
    ...
    class SchemaParser {
    public:
        SchemaParser(const srt::svs::InferenceSpec *spec_, ErrorCollector *ec_) : spec(spec_), ec(ec_) {
    ...
    private:
        ...
        const srt::svs::InferenceSpec *spec;
        ErrorCollector *ec;
        const srt::core::JsonObject *pSchema;
    };
    ...
    private:
        const srt::svs::InferenceSpec *spec;
        ErrorCollector *ec;
        const srt::core::JsonObject *pOptions;
    };
}
