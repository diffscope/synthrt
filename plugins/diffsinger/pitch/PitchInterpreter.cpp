...
namespace srt::svs {
    ...
    srt::core::Expected<srt::core::NO<srt::svs::InferenceSchema>>
        PitchInterpreter::createSchema(const srt::svs::InferenceSpec *spec) const {
        if (!spec) {
        ...
        auto result = srt::core::NO<Pit::PitchSchema>::create();
    ...
    srt::core::Expected<srt::core::NO<srt::svs::InferenceConfiguration>>
        PitchInterpreter::createConfiguration(const srt::svs::InferenceSpec *spec) const {
        if (!spec) {
            // fatal error: null pointer, return immediately
            return srt::core::Error{
                srt::core::Error::InvalidArgument,
        ...
        auto result = srt::core::NO<Pit::PitchConfiguration>::create();
    ...
    srt::core::Expected<srt::core::NO<srt::svs::InferenceImportOptions>>
        PitchInterpreter::createImportOptions(const srt::svs::InferenceSpec *spec,
        ...
        auto result = srt::core::NO<Pit::PitchImportOptions>::create();
    ...
    srt::core::Expected<srt::core::NO<srt::svs::Inference>> PitchInterpreter::createInference(
        ...
        return srt::core::NO<PitchInference>::create(spec);
    }
