...
namespace srt::svs {
    ...
    srt::core::Expected<srt::core::NO<srt::svs::InferenceSchema>>
        DurationInterpreter::createSchema(const srt::svs::InferenceSpec *spec) const {
        if (!spec) {
        ...
        auto result = srt::core::NO<Dur::DurationSchema>::create();
    ...
    srt::core::Expected<srt::core::NO<srt::svs::InferenceConfiguration>>
        DurationInterpreter::createConfiguration(const srt::svs::InferenceSpec *spec) const {
        if (!spec) {
            // fatal error: null pointer, return immediately
            return srt::core::Error{
                srt::core::Error::InvalidArgument,
        ...
        auto result = srt::core::NO<Dur::DurationConfiguration>::create();
    ...
    srt::core::Expected<srt::core::NO<srt::svs::InferenceImportOptions>>
        DurationInterpreter::createImportOptions(const srt::svs::InferenceSpec *spec,
        ...
        auto result = srt::core::NO<Dur::DurationImportOptions>::create();
    ...
    srt::core::Expected<srt::core::NO<srt::svs::Inference>> DurationInterpreter::createInference(
        ...
        return srt::core::NO<DurationInference>::create(spec);
    }
