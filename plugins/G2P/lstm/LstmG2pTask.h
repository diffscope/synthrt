#ifndef SRT_G2P_PLUGINS_LSTMG2PTASK_H
#define SRT_G2P_PLUGINS_LSTMG2PTASK_H
...
{
    class LstmG2pTask : public srt::g2p::Task {
    public:
        explicit LstmG2pTask(const srt::g2p::ModuleSpec *spec);
...
#endif // SRT_G2P_PLUGINS_LSTMG2PTASK_H
